...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property ProfessionId = new Property(4, long.class, "professionId", false, "PROFESSION_ID");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER\" (" + //
                ...
                "\"PROFESSION_ID\" INTEGER NOT NULL );"); // 4: professionId
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, User entity) {
        ...
        stmt.bindLong(5, entity.getProfessionId());
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.getLong(offset + 4) // professionId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setProfessionId(cursor.getLong(offset + 4));
     }
